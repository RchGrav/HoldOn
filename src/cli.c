...
static const struct hold_cli_command_spec command_specs[] = {
    ...
    {"start", 1, -1, HOLD_CLI_ALLOW_DDASH, "usage: hold start <profile> [--multi [N]] [--console]\n       hold start <cmd> [args...]", "start"},
